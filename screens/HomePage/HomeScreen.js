...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, FlatList, SafeAreaView,useWindowDimensions } from 'react-native';
...
const HomeScreen = (props) => {
    ...
    const renderAppointments = ({ item }) => {
        return (
            <AppointmentCard ButtonClick={() => props.navigation.navigate('AppointmentDetails', ({ item }))}
